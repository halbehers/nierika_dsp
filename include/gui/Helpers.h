...
#define SVG_BACKGROUND_COLOR "#ffffff"
...
void drawFromAnimatedSVG(juce::Graphics& g, const std::vector<const char*>& frames, int frameIndex, const juce::String& colHex, int x, int y, int newWidth, int newHeight, juce::AffineTransform affine, const juce::Colour& backgroundColor = juce::Colours::transparentBlack);
...
void drawFromAnimatedSVGBlended(juce::Graphics& g, const std::vector<const char*>& frames, int frameIndex, int nextFrameIndex, float blendAlpha, const juce::String& colHex, int x, int y, int newWidth, int newHeight, juce::AffineTransform affine, const juce::Colour& backgroundColor = juce::Colours::transparentBlack);
...
void drawFromInterpolatedSVG(juce::Graphics& g, const juce::XmlElement& interpolatedFrame, const juce::String& colHex, int x, int y, int newWidth, int newHeight, juce::AffineTransform affine, float opacity = 1.0f, const juce::Colour& backgroundColor = juce::Colours::transparentBlack);
