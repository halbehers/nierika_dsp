...
public:
    ...
    void addComponent(const std::string& identifier, juce::Component& component, int rowPosition, int columnPosition, int width = 1, int height = 1, int zOrder = 1, Alignment alignment = Alignment::TOP_LEFT);
    void addComponent(Component& component, int rowPosition, int columnPosition, int width = 1, int height = 1, int zOrder = 1, Alignment alignment = Alignment::TOP_LEFT);
